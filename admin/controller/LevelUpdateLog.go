...
type CLevelUpdateLog struct {
	Services service.SLevelUpdateLog
	BaseController
}

func (this *CLevelUpdateLog) Index(ctx *gin.Context) {
	...
	ctx.HTML(http.StatusOK, "levelupdatelog_index.html", gin.H{
		"status": "200",
		"List":   result,
		"Count":  count,
		"Search": Search,
...
func (this *CLevelUpdateLog) Edit(ctx *gin.Context) {
	...
	if ctx.Request.Method == "GET" {
		...
		// 查询权限列表
		ctx.HTML(http.StatusOK, "levelupdatelog_form.html", gin.H{
			"status":   "200",
			"result":   result,
			"language": language,
			"IsUpdate": true,
...
func (this *CLevelUpdateLog) Delete(ctx *gin.Context) {
...
func (this *CLevelUpdateLog) Add(ctx *gin.Context) {
	if ctx.Request.Method == "GET" {
...
func (this *CLevelUpdateLog) Deletebatch(ctx *gin.Context) {
