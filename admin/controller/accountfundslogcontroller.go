...
type AccountFundsLog struct {
	Services service.AccountFundsLog
	BaseController
}

func (this *AccountFundsLog) Index(ctx *gin.Context) {
	...
	Search := map[string]interface{}{
		...
		"money_type": req.MoneyType,
	}

	ctx.HTML(http.StatusOK, "accountfundslog_index.html", gin.H{
		"status": "200",
		"List":   result,
		"Count":  count,
		"Search": Search,
