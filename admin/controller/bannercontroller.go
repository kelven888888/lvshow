...
func (this *BannerController) Index(ctx *gin.Context) {
...
func (this *BannerController) Edit(ctx *gin.Context) {
...
func (this *BannerController) Delete(ctx *gin.Context) {
...
func (this *BannerController) Add(ctx *gin.Context) {
	if ctx.Request.Method == "GET" {
...
func (this *BannerController) Deletebatch(ctx *gin.Context) {
