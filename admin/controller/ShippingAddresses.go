...
type CShippingAddresses struct {
	Services service.SShippingAddresses
	BaseController
}

func (this *CShippingAddresses) Index(ctx *gin.Context) {
...
func (this *CShippingAddresses) Edit(ctx *gin.Context) {
...
func (this *CShippingAddresses) Delete(ctx *gin.Context) {
...
func (this *CShippingAddresses) Add(ctx *gin.Context) {
	if ctx.Request.Method == "GET" {
...
func (this *CShippingAddresses) Deletebatch(ctx *gin.Context) {
