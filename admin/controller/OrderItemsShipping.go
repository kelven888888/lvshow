...
type COrderItemsShipping struct {
	Services service.SOrderItemsShipping
	BaseController
}

func (this *COrderItemsShipping) Index(ctx *gin.Context) {
	...
	ctx.HTML(http.StatusOK, "orderitemsshipping_index.html", gin.H{
		"status": "200",
		"List":   result,
		"Count":  count,
		"Search": Search,
...
func (this *COrderItemsShipping) Edit(ctx *gin.Context) {
	...
	if ctx.Request.Method == "GET" {
		...
		// 查询权限列表
		ctx.HTML(http.StatusOK, "orderitemsshipping_form.html", gin.H{
			"status":   "200",
			"result":   result,
			"language": language,
			"IsUpdate": true,
...
func (this *COrderItemsShipping) Delete(ctx *gin.Context) {
...
func (this *COrderItemsShipping) Add(ctx *gin.Context) {
	if ctx.Request.Method == "GET" {
...
func (this *COrderItemsShipping) Deletebatch(ctx *gin.Context) {
