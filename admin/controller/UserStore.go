...
type CUserStore struct {
	Services service.SUserStore
	BaseController
}

func (this *CUserStore) Index(ctx *gin.Context) {
	...
	ctx.HTML(http.StatusOK, "userstore_index.html", gin.H{
		"status": "200",
		"List":   result,
		"Count":  count,
		"Search": Search,
...
func (this *CUserStore) Edit(ctx *gin.Context) {
	...
	if ctx.Request.Method == "GET" {
		...
		// 查询权限列表
		ctx.HTML(http.StatusOK, "userstore_form.html", gin.H{
			"status":   "200",
			"result":   result,
			"language": language,
			"IsUpdate": true,
...
func (this *CUserStore) Delete(ctx *gin.Context) {
...
func (this *CUserStore) Add(ctx *gin.Context) {
	if ctx.Request.Method == "GET" {
...
func (this *CUserStore) Deletebatch(ctx *gin.Context) {
