...
type CWalletChain struct {
	Services service.SWalletChain
	BaseController
}

func (this *CWalletChain) Index(ctx *gin.Context) {
...
func (this *CWalletChain) Edit(ctx *gin.Context) {
...
func (this *CWalletChain) Delete(ctx *gin.Context) {
...
func (this *CWalletChain) Add(ctx *gin.Context) {
	if ctx.Request.Method == "GET" {
...
func (this *CWalletChain) Deletebatch(ctx *gin.Context) {
