...
type CGameLottyRecord struct {
	Services service.SGameLottyRecord
	BaseController
}

func (this *CGameLottyRecord) Index(ctx *gin.Context) {
...
func (this *CGameLottyRecord) Edit(ctx *gin.Context) {
...
func (this *CGameLottyRecord) Delete(ctx *gin.Context) {
...
func (this *CGameLottyRecord) Add(ctx *gin.Context) {
	if ctx.Request.Method == "GET" {
...
func (this *CGameLottyRecord) Deletebatch(ctx *gin.Context) {
