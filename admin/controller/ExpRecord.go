...
type CExpRecord struct {
	Services service.SExpRecord
	BaseController
}

func (this *CExpRecord) Index(ctx *gin.Context) {
	...
	ctx.HTML(http.StatusOK, "exprecord_index.html", gin.H{
		"status": "200",
		"List":   result,
		"Count":  count,
		"Search": Search,
...
func (this *CExpRecord) Edit(ctx *gin.Context) {
	...
	if ctx.Request.Method == "GET" {
		...
		// 查询权限列表
		ctx.HTML(http.StatusOK, "exprecord_form.html", gin.H{
			"status":   "200",
			"result":   result,
			"language": language,
			"IsUpdate": true,
...
func (this *CExpRecord) Delete(ctx *gin.Context) {
...
func (this *CExpRecord) Add(ctx *gin.Context) {
	if ctx.Request.Method == "GET" {
...
func (this *CExpRecord) Deletebatch(ctx *gin.Context) {
