...
type COrderItems struct {
	Services service.SOrderItems
	BaseController
}

func (this *COrderItems) Index(ctx *gin.Context) {
	...
	ctx.HTML(http.StatusOK, "orderitems_index.html", gin.H{
		"status": "200",
		"List":   result,
		"Count":  count,
		"Search": Search,
...
func (this *COrderItems) Edit(ctx *gin.Context) {
	...
	if ctx.Request.Method == "GET" {
		...
		// 查询权限列表
		ctx.HTML(http.StatusOK, "orderitems_form.html", gin.H{
			"status":   "200",
			"result":   result,
			"language": language,
			"IsUpdate": true,
...
func (this *COrderItems) Delete(ctx *gin.Context) {
...
func (this *COrderItems) Add(ctx *gin.Context) {
	if ctx.Request.Method == "GET" {
...
func (this *COrderItems) Deletebatch(ctx *gin.Context) {
