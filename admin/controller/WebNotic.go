...
type CWebNotic struct {
	Services service.SWebNotic
	BaseController
}

func (this *CWebNotic) Index(ctx *gin.Context) {
	...
	ctx.HTML(http.StatusOK, "webnotic_index.html", gin.H{
		"status": "200",
		"List":   result,
		"Count":  count,
		"Search": Search,
...
func (this *CWebNotic) Edit(ctx *gin.Context) {
	...
	if ctx.Request.Method == "GET" {
		...
		// 查询权限列表
		ctx.HTML(http.StatusOK, "webnotic_form.html", gin.H{
			"status":   "200",
			"result":   result,
			"language": language,
			"IsUpdate": true,
...
func (this *CWebNotic) Delete(ctx *gin.Context) {
...
func (this *CWebNotic) Add(ctx *gin.Context) {
	if ctx.Request.Method == "GET" {
...
func (this *CWebNotic) Deletebatch(ctx *gin.Context) {
